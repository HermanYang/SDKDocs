...
class BaseTransform(node_transform.NodeTransform):
    ...
    def create_image_attr(kernel_size, strides, padding, data_format):
        ...
        h_index, w_index, _ = BaseTransform._get_hw_ind_from_data_format(data_format)
    ...
    @staticmethod
    def _get_hw_ind_from_data_format(data_format):
    ...
    def _get_height_and_width_indices(image_attr):
        return BaseTransform._get_hw_ind_from_data_format(image_attr.data_format)
