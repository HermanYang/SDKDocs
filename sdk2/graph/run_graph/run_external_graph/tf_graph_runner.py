...
from sdk2.graph.import_graph import tf_saved_model_base_importer
from sdk2.graph.run_graph.run_external_graph import external_graph_runner
from sdk2.graph.transform_graph import utils
from sdk2.graph.transform_graph.graph_transformers import add_update_variables_nodes
from sdk2.inference import tf_ops
from sdk2.proto import inference_pb2, lgf_pb2
    ...
    def run(self, inputs):
        ...
        with tf.Session(graph=graph) as sess:
            ...
            meta_graph_def = tf.saved_model.loader.load(
                sess, [tf.saved_model.tag_constants.SERVING], self._graph_path)
