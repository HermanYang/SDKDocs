from sdk2.graph.transform_graph.node_transformers.generic_transforms import pad_transform
...
class TFSavedModelPadTransform(tf_base_transform.TFSavedModelBaseTransform,
    ...
    def transform(self, pad_node, light_graph):
        ...
        return self.do_generic_transform(pad_node.name, pad_node.inputs[0],
                                         pad_node.outputs[0], pad_node.control_inputs,
                                         padding)
