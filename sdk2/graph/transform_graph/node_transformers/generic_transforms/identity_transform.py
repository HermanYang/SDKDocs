...
class IdentityTransform(electronic_op_transform.ElectronicOpTransform):
    ...
    def create_supported_nodes(self, identity_name, input_edge, output_edge,
                               control_inputs):
        """
        ...
        """
        return [
            self.create_simple_node(identity_name, lgf_pb2.LNF.identity.DESCRIPTOR.name,
    ...
    def transform(self, identity_node, light_graph):
        ...
        return self.do_generic_transform(identity_node.name, identity_node.inputs[0],
