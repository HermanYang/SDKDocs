...
from sdk2.graph.transform_graph.node_transformers import node_transform
from sdk2.proto import dtypes_pb2, lgf_pb2, transform_result_pb2
    ...
    def _get_dtype(self):
        if self._is_quantized():
            dtype = self._get_qint_dtype(
                self._sw_config.quantized_electronic_op_precision, True)
        else:
