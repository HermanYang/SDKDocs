...
from sdk2.graph.transform_graph.node_transformers.generic_transforms import (
    conv2d_transform, reshape_transform, transpose_transform)
from sdk2.proto import hw_spec_pb2, lgf_pb2
...
class DistributedDepthwiseConv2D(conv2d_transform.Conv2DTransform,
    ...
    def preprocess_weights(self, weights_edge):
        ...
        transpose_node = transpose_transform.TransposeTransform.create_supported_nodes(
            self, transpose_edge.name, weights_edge, transpose_edge, [], [0, 1, 3, 2])[0]
        ...
        reshape_node = reshape_transform.ReshapeTransform.create_supported_nodes(
            self, reshape_edge.name, transpose_node.outputs[0], reshape_edge, [])[0]
