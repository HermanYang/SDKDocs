...
class VVTransform(electronic_op_transform.ElectronicOpTransform):
    ...
    def create_supported_nodes(self, vv_name, input0_edge, input1_edge, output_edge,
                               control_inputs):
        """
        ...
        """
        return [
            self.create_simple_node(vv_name, self.vv_node_type(),
                                    [input0_edge, input1_edge], [output_edge],
                                    control_inputs)
        ]
    ...
    def transform(self, vv_node, light_graph):
        ...
        return self.do_generic_transform(vv_node.name, vv_node.inputs[0],
                                         vv_node.inputs[1], vv_node.outputs[0],
