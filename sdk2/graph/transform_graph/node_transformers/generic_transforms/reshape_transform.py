...
class ReshapeTransform(electronic_op_transform.ElectronicOpTransform):
    ...
    def create_supported_nodes(self, reshape_name, input_edge, output_edge,
                               control_inputs):
        """
        ...
        """
        return [
            self.create_simple_node(reshape_name, lgf_pb2.LNF.reshape.DESCRIPTOR.name,
    ...
    def transform(self, reshape_node, light_graph):
        ...
        return self.do_generic_transform(reshape_node.name, reshape_node.inputs[0],
